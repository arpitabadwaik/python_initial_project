var Login = function () {
    ...
    return {
        init: function () {
            e(), r(), s(), $.backstretch(["{% static 'assets/pages/media/bg/1.jpg' %}", "{% static 'assets/pages/media/bg/2.jpg' %}", "{% static 'assets/pages/media/bg/3.jpg' %}", "{% static 'assets/pages/media/bg/4.jpg' %}"], {
                fade: 1e3,
                duration: 8e3
            })
        }
